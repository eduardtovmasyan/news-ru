                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="single-about-txt">
                                <h3>
                                    I am a Full Stack web developer, experienced in HTML5, CSS3 (Bootstrap), JavaScript (jQuery), Vue.js,
                                </h3>
                                <p>
                                    an excellent communicator and great team worker. I can work on my initiative as well as with others
                                    and enjoy learning and getting involved in new skills.
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <p class="description">
                                            Economics and Management of Enterprises
                                                (in the Sphere of Municipal, Housing and
                                                Communal Services) 
                                        </p>
                                    </div><!--/.timeline-content-->
                                </div><!--/.timeline-->
                            ...
                            <div class="single-horizontal-timeline">
                                ...
                                <div class="timeline">
                                    <div class="timeline-content">
                                        ...
                                        <h5>Yerevan, Armenia</h5>
                                        <p class="description">
                                            "ELITA" RUBEN SARGSYAN AUTHOR'S SCHOOL
                                        </p>
                                    </div><!--/.timeline-content-->
                                </div><!--/.timeline-->
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="single-skill-content">
                                    ...
                                    <div class="barWrapper">
                                        <span class="progressText">REST API</span>
                                        <div class="single-progress-txt">
                                            <div class="progress ">
                            ...
                            <div class="col-md-6">
                                <div class="single-skill-content">
                                    <div class="barWrapper">
                                        <span class="progressText">Vue js</span>
                                        <div class="single-progress-txt">
                                            <div class="progress ">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="10" aria-valuemax="100" style="">
                                    ...
                                    <div class="barWrapper">
                                        <span class="progressText">AJAX</span>
                                        <div class="single-progress-txt">
                                            <div class="progress ">
                                               <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="10" aria-valuemax="100" style="">
                                            ...
                                            <div class="col-md-offset-1 col-md-5">
                                                <div class="timeline">
                                                    <div class="timeline-content">
                                                        <h4 class="title">
                                                            <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                                                            ANAU Information Technologies Center
                                                        </h4>
                                                        <h5>Yerevan, Armenia</h5>
                                                        <p class="description">
                                                            Duis aute irure dolor in reprehenderit in vol patate velit esse cillum dolore eu fugiat nulla pari. Excepteur sint occana inna tecat cupidatat non proident. 
                            ...
                            <div class="single-contact-box">
                                <div class="contact-adress">
                                    ...
                                    <div class="contact-add-info">
                                        ...
                                        <div class="single-contact-add-info">
                                            <h3>email</h3>
                                            <p>edotovmasyan21@gmail.com</p>
                                        </div>
                                        <div class="single-contact-add-info">
                                            <h3>github</h3>
                                            <p><a href="https://github.com/eduardtovmasyan" target="_blank">eduardtovmasyan</a></p>
                                        </div>
                                    </div>
                                </div><!--/.contact-adress-->
